...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { key: "test-all", label: "/test-all", description: "Generate tests for all requests in the collection", prompt: "Generate JavaScript test scripts using pm.test() and pm.expect() for the following HTTP request. Include tests for: status code, response time, content-type header, and response body structure. Return ONLY a ```json code block with:\n{\"type\":\"write_test\",\"description\":\"Test script\",\"data\":{\"script\":\"...\",\"language\":\"javascript\"}}" },
