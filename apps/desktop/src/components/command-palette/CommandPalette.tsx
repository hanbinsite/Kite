...
export function CommandPalette({ isOpen, onClose, items }: CommandPaletteProps) {
  ...
  return (
    <div className="fixed inset-0 z-command-palette">
      ...
      <div className="absolute top-[20vh] left-1/2 -translate-x-1/2 w-[560px] max-h-[480px] bg-bg-elevated border border-border-default rounded-xl shadow-xl overflow-hidden animate-fade-in-up">
