...
async fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::script_templates::list_script_templates,
            commands::script_templates::save_script_template,
            commands::script_templates::delete_script_template,
            commands::importer::import_curl,
            commands::importer::import_postman,
            commands::importer::import_har,
            commands::importer::detect_import_format,
            commands::importer::export_postman,
            commands::importer::export_curl,
